...
feature_vector = [median_value min_value max_value range_value mean_value std_deviation avg_distance_peaks peak_periodicity ar_coeff(2) ar_coeff(3) ar_e crossings signal_integral var_d1 var_d2 var_d3 var_d4 var_d5 var_a1 var_a2 var_a3 var_a4 var_a5 grid_number]
end